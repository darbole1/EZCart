...
public class LoginView extends javax.swing.JFrame {
     ...
     * LoginView
     *
     * @description constructor that Creates new form
     */
    public LoginView() {
        initComponents();
        setSize(900, 600);
     ...
     * hideLoginView
     *
     * @description this method is used to set the LoginView JFrame NOT visible
     */
     ...
     * initComponents
     *
     * @description This method is called from within the constructor to
    ...
    /**
     * forgotPasswordLabelMouseClicked
     *
     * @description this method is used to call the method to reset the password
     */
     ...
     *
     * @description on click takes user name and password and provides them to
    ...
    /**
     * backToInventoryButtonActionPerformed
     *
     * @description this method takes the user back to the System (main) view
     */
